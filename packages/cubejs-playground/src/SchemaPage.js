...
class SchemaPage extends Component {
  ...
  async generateSchema() {
    ...
    if (res.status === 200) {
      ...
      playgroundAction('生成维度模式失败', { error: await res.text() });
    }
  }
      ...
      <Layout style={{ height: '100%' }}>
        ...
        <Content style={{ minHeight: 280 }}>
          ...
          {selectedFile
            ...
            : <Empty style={{ marginTop: 50 }} description="选择左侧的数据表来生成维度模式" />
          }
